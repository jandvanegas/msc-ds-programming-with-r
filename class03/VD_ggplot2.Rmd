...
* To run the program you need to install the the <tt>xaringan</tt> package.
...
* ggplot2 Cheat Sheet: [ggplot2](https://www.maths.usyd.edu.au/u/UG/SM/STAT3022/r/current/Misc/data-visualization-2.1.pdf).
...
as.factor converts cy1 to a factor variable, so it is represented as categorical and not number
]
...
* The density with the black line has variance 1 and density with the green line has variance 2.  
  *  Note that we use lines to add dx3 to the already plot x.
]
